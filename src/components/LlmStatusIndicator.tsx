    ...
    <div className="relative">
      ...
      >
        ...
        {responseTime && (
          <Badge
            variant="outline"
            className="text-xs ml-1 bg-white/70 backdrop-blur-sm"
          >
            {responseTime}ms
          </Badge>
        )}
      ...
      {isExpanded && (
        <Card className="absolute top-full right-0 mt-2 w-72 z-50 shadow-xl border animate-in slide-in-from-top-2 duration-200 bg-white/95 backdrop-blur-sm">
