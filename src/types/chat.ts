...
export interface WorkflowData {
    steps: WorkflowStep[];
    currentStep?: WorkflowStep;    status: 'idle' | 'running' | 'completed' | 'error';
    error?: string;
    metadata?: Record<string, unknown>;
}
...
export type StreamEventType = 'content' | 'step' | 'error' | 'workflow_complete' | 'workflow_step' | 'final_response';
